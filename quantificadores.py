...
Felipe, felipe teimoso
Jã
'''

print(re.findall(r'j[o]+ão+', texto, flags=re.I))
print(re.findall(r'jo{2,}ão{3,}', texto, flags=re.I))
print(re.findall(r've{3}m{,4}', texto, flags=re.I))
print(re.sub(r'jo{1,}ão{1,}', 'Felipe', texto, flags=re.I))
print(re.sub(r'fe{1,}li{2,}', 'João', texto, flags=re.I))
